        ...
        <section class="single-project__content-section">
            <div class="container">
                <div class="single-project__content">
                    ...
                    <!-- <h2 class="single-project__title">Какие данные могут обрабатываться</h2>
                    <ul>
                        <li class="text-base">технические данные, которые обычно фиксируются сервером и средствами хостинга: IP-адрес, данные браузера (user-agent), дата и время запроса, запрашиваемые страницы;</li>
                        <li class="text-base">данные, которые пользователь передает при обращении по телефону или электронной почте, указанным на сайте.</li>
                    </ul> -->
